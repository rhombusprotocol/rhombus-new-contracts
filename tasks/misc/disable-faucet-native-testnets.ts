...
import { getFaucet, getWrappedTokenGateway, getPoolConfiguratorProxy } from '../../helpers/contract-getters';
import { waitForTx } from '../../helpers/utilities/tx';

task(`disable-faucet-native-testnets`, `Disables faucet of native tokens and borrowing of native tokens`).setAction(async ({}, hre) => {
