...
import { ConfigNames, eNetwork, getPool, getPoolLibraries, isL2PoolSupported, loadPoolConfig, waitForTx } from '../../helpers';
...
const func: DeployFunction = async function ({ getNamedAccounts, deployments, ...hre }: HardhatRuntimeEnvironment) {
  ...
  try {
    ...
    console.log('Pool Implementation already initialized');
  }
};
